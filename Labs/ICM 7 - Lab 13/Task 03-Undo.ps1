# MODULE undo Remove a VMFS Datastore
...
{
 $ProgressTextBox.text=""
 $ProgressTextBox.text="Datastore $Current_SecondDatatoreName already exists"
 # a delay so the message can be seen
 Start-sleep 5
}
else
{
 $ProgressTextBox.text=""
 $ProgressTextBox.text="Recreating Datastore $Current_SecondDatatoreName"
...
$ProgressTextBox.text= "Lab 13 Task 3 Undone"
# End of Module
