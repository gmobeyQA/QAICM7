# MODULE TO Get Ready for Lab 13 Task 3
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 13 Task 3)"
...
if ($?)
{
 ...
 $ProgressTextBox.text= "Ready For Lab 13 Task 3"
}