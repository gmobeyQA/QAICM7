# MODULE TO Get Ready for Lab 13 Task 5
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 13 Task 5)"
...
if ($?)
{
 ...
 $ProgressTextBox.text= "Ready For Lab 13 Task 5"
}