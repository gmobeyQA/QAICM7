# MODULE TO Get Ready for Lab 25 Task 2
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 25 Task 2)"
...
else
{
 ...
 $ProgressTextBox.text= "Ready For Lab 21 Task 2"
}