# MODULE TO Create Folders for VMs and VM Templates
...
if ($?)
{
 ...
 {
  $ProgressTextBox.text=""
  $ProgressTextBox.text="VMs & Templates Folder $CurrentVTFolder1 is not inside  $CurrentDataCenter"
  # a delay so the message can be seen
  Start-sleep 5
  $Folder1=$false
 }
 ...
 if ($folder1)
 {
  ...
  {
   $ProgressTextBox.text=""
   $ProgressTextBox.text="Both Folders exist"
   # a delay so the message can be seen
   Start-sleep 5
  }
  Get-Folder -Name $CurrentVTFolder1 | Get-VM -Name $CurrVM1  >$null 2>&1
  if ($?)
  {
   $ProgressTextBox.text=""
   $ProgressTextBox.text="$CurrVM1 is in folder $CurrentVTFolder1"
   # a delay so the message can be seen
   Start-sleep 5
   $VM1inFolder=$true
  }
  ...
  {
   $ProgressTextBox.text=""
   $ProgressTextBox.text="$CurrVM1 is not in folder $CurrentVTFolder1"
   # a delay so the message can be seen
   Start-sleep 5
   $VM1inFolder=$false
  }
  Get-Folder -Name $CurrentVTFolder1 | Get-VM -Name $CurrVM2  >$null 2>&1
  if ($?)
  {
   $ProgressTextBox.text=""
   $ProgressTextBox.text="$CurrVM2 is in folder $CurrentVTFolder1"
   # a delay so the message can be seen
   Start-sleep 5
   $VM2inFolder=$true
  }
  ...
  {
   $ProgressTextBox.text=""
   $ProgressTextBox.text="$CurrV21 is not in folder $CurrentVTFolder1"
   # a delay so the message can be seen
   Start-sleep 5
   $VM2inFolder=$false
  }
  Get-Folder -Name $CurrentVTFolder1 | Get-VM -Name $CurrVM3  >$null 2>&1
  if ($?)
  {
   $ProgressTextBox.text=""
   $ProgressTextBox.text="$CurrVM3 is in folder $CurrentVTFolder1"
   # a delay so the message can be seen
   Start-sleep 5
   $VM3inFolder=$true
  }
  ...
  {
   $ProgressTextBox.text=""
   $ProgressTextBox.text="$CurrVM3 is not in folder $CurrentVTFolder1"
   # a delay so the message can be seen
   Start-sleep 5
   $VM3inFolder=$false
  }
  if (($Folder2) -and ($VM3inFolder -and $VM3inFolder -and $VM3inFolder))
  {
   $ProgressTextBox.BackColor="Green"
  $ProgressTextBox.text=""
   $ProgressTextBox.text= "Task 6 Done"
  }
  else
  {
   $ProgressTextBox.BackColor="Red"
   $ProgressTextBox.text=""
   $ProgressTextBox.text= "Redo Lab 7 Task 6"
  }
 }
