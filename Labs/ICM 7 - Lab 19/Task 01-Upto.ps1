# MODULE TO Get Ready for Lab 19 Task 1
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 19 Task 1)"
...
# removed creating vmfs-3 as it's been/going_to_be reused
...
else
{
 ...
 else
 {
  ...
  Add-TemplateToLibrary -LibraryName $ContLib -Templatename $Template2Clone -LibItemName $ContLibTempl -Description "Lab 19 Task 1"
  start-sleep 3
 }
...
Start-sleep 1
 ...
 $ProgressTextBox.text= "Ready For Lab 19 Task 1"
}