# MODULE TO Get Ready for Lab 3 Task 1
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 3 Task 1)"
...
{
 $ProgressTextBox.text=""
 $ProgressTextBox.text= "Virtual Machine $CurrentCrVmName is already created on $CurrentH1" }
else
{
 $ProgressTextBox.text=""
 $ProgressTextBox.text= "Create VM $CurrentCrVmName on $CurrentH1"
 # a delay so the message can be seen
 Start-sleep 5
...
$ProgressTextBox.text= "Ready For Lab 3 Task 1"
# End of Module