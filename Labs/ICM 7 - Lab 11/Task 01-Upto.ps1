# MODULE TO Get Ready for Lab 11 Task 1
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 11 Task 1)"
...
if ($CarryOn)
{
 ...
 $ProgressTextBox.text= "Ready For Lab 11 Task 1"
}