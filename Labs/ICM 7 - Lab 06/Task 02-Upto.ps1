# MODULE TO Get Ready for Lab 6 Task 2
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 6 Task 2)"
...
$ProgressTextBox.text= "Ready For Lab 6 Task 2"
$CarryOn=$true
}
else
{
...
if ($CorrectVCLic)
{$ProgressTextBox.text="Stopping before Lab 6 Task 1.. need the correct vSphere License Key"}
elseif ($CorrectVsLic)
{$ProgressTextBox.text="Stopping before Lab 6 Task 1.. need the correct vCenter License Key"}
else
{$ProgressTextBox.text=  "Stopping before Lab 6 Task 1.. need correct vCenter and vSphere License Keys"}
$CarryOn=$false
}