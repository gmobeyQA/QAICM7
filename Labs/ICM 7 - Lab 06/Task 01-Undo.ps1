# MODULE undo Add vSphere Licenses to vCenter Server
...
{
$ProgressTextBox.text=""
$ProgressTextBox.text="Remove vCenter License $vcKey"
# a delay so the message can be seen
Start-sleep 5
$LM = get-view($vCenter.ExtensionData.content.LicenseManager)
$LM.RemoveLicense($vcKey)
...
{
$ProgressTextBox.text=""
$ProgressTextBox.text="Remove vSphere License $vSKey"
# a delay so the message can be seen
Start-sleep 5
$LM = get-view($vCenter.ExtensionData.content.LicenseManager)
$LM.RemoveLicense($vsKey)
#$LAM = get-view($LicenseManager.licenseAssignmentManager)
#$LAM.UpdateAssignedLicense($vCenter.InstanceUuid,$vsKey,$Null)
$CorrectVsLic=$?
}
...
$ProgressTextBox.text=  "Both the Licenses have been Removed from $CurrectVC"
# a delay so the message can be seen
Start-sleep 5
$ProgressTextBox.text=""
$ProgressTextBox.BackColor="Green"
$ProgressTextBox.text= "Lab 6 Task 1 Undone"
}
else
{
$ProgressTextBox.text=""
$ProgressTextBox.text=  "the Licenses have not been Removed from $CurrectVC"
# a delay so the message can be seen
Start-sleep 5
$ProgressTextBox.text=""
$ProgressTextBox.BackColor="Red"
$ProgressTextBox.text= "Check the keys and whether the licenses are there"
}
