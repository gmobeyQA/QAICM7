# MODULE to Add vSphere Licenses to vCenter Server
...
$ProgressTextBox.text= "Lab 6 Task 1 Done"
}
else
{
$ProgressTextBox.text=""
...
if ($CorrectVCLic)
{$ProgressTextBox.text="Redo Lab 6 Task 1.. with correct vSphere License Key"}
elseif ($CorrectVsLic)
{$ProgressTextBox.text="Redo Lab 6 Task 1.. with correct vCenter License Key"}
else
{$ProgressTextBox.text=  "Redo Lab 6 Task 1.. with correct vCenter and vSphere License Keys"}
}
# End of Module