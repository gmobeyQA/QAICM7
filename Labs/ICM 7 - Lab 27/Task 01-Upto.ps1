# MODULE TO Get Ready for Lab 27 Task 1
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 27 Task 1)"
...
$thisCluster=Get-Cluster -Name $CurrCluster 
 ...
 $ProgressTextBox.text= "Ready For Lab 27 Task 1"
}