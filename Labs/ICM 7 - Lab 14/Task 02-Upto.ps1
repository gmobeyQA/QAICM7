# MODULE TO Get Ready for Lab 14 Task 1
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 14 Task 1)"
...
sleep 1
 ...
 $ProgressTextBox.text= "Ready For Lab 14 Task 1"
}