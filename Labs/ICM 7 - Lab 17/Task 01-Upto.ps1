# MODULE TO Get Ready for Lab 17 Task 1
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 17 Task 1)"
...
else
{
 $crVM1=$true
 # First Deploy
 $task01=New-VM -Name $VM2Deploy1 -Template $CurrTemplate -VMHost $CurrentH1 -Datastore $SharedDatastoreName -OSCustomizationSpec $Cust_Spec -Location ($ThisVMFolder) -RunAsync
 $ProgressTextBox.text=""
...
else
{
 ...
 # First Deploy
 #Second Deploy
 $task02=New-VM -Name $VM2Deploy2 -Template $CurrTemplate -VMHost $CurrentH2 -Datastore $SharedDatastoreName -OSCustomizationSpec $Cust_Spec -Location ($ThisVMFolder) -RunAsync
 $ProgressTextBox.text=""
...
else
{
 ...
 $ProgressTextBox.text= "Ready For Lab 17 Task 1"
}