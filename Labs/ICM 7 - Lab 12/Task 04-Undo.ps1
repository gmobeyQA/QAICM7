# MODULE Undo Connect the iSCSI Software Adapters to Storage
...
$ProgressTextBox.text= "Remove iSCSI Targets"
Get-IScsiHbaTarget -iscsihba $hbahost| Remove-IScsiHbaTarget -Confirm:$false  >$null 2>&1
...
$ProgressTextBox.text= "Lab 12 Task 4 Undone"
# End of Module