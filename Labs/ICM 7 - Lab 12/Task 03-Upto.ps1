# MODULE TO Get Ready for Lab 12 Task 3
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 12 Task 3)"
...
if ($CarryOn)
{
 ...
 $ProgressTextBox.text= "Ready For Lab 12 Task 3"
}