# MODULE TO Get Ready for Lab 18 Task 3
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 18 Task 3)"
...
else
{
 ...
 else
 {
  ...
  Add-TemplateToLibrary -LibraryName $ContLib -Templatename $Template2Clone -LibItemName $ContLibTempl -Description "Lab 18 Task 3"
  start-sleep 3
 }
...
$Thisvm = Get-VM -Name $CurrVM3
 ...
 $ProgressTextBox.text= "Ready For Lab 18 Task 3"
}