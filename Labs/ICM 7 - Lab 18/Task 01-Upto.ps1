# MODULE TO Get Ready for Lab 18 Task 1
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 18 Task 1)"
...
else
{
 ...
 else
 {
  ...
  Add-TemplateToLibrary -LibraryName $ContLib -Templatename $Template2Clone -LibItemName $ContLibTempl -Description "Lab 18 Task 1"
  start-sleep 3
 }
...
# not needed by other scripts
 ...
 $ProgressTextBox.text= "Ready For Lab 18 Task 1"
}