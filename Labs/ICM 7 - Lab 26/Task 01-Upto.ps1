# MODULE TO Get Ready for Lab 26 Task 1
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 26 Task 1)"
...
if ($?)
{
 ...
 start-sleep 5
 $thisCluster=Get-Cluster -Name $CurrCluster 
...
{
 $ProgressTextBox.text=""
 $ProgressTextBox.text= "Creating Cluster $CurrCluster"
 New-Cluster -Name $CurrCluster -DrsEnabled -location (Get-Datacenter -Name $CurrentDataCenter)  >$null 2>&1
 start-sleep 5
 }
 ...
 $ProgressTextBox.text= "Ready For Lab 21 Task 3"
}