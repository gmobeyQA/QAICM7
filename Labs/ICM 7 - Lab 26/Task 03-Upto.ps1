# MODULE TO Get Ready for Lab 26 Task 3
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 26 Task 3)"
...
$thisCluster=Get-Cluster -Name $CurrCluster 
 ...
 $ProgressTextBox.text= "Ready For Lab 26 Task 3"
}