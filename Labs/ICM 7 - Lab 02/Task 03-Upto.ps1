# MODULE TO Get Ready for Lab 2 Task 3
$ProgressTextBox.BackColor = "Black"
$ProgressTextBox.text=$ProgressTextBox.text+" (Get Ready for Lab 2 Task 3)"
...
$CurrAuth=Get-VMHostAuthentication -VMHost $CurrentH -Server $CurrentH
$CurrentAuthD=$CurrAuth.Domain
if ("$CurrentAuthD" -notlike "VCLASS.LOCAL")
{
        $ProgressTextBox.text = "Adding AD Domain Authentication to $CurrentH"
        ...
        $ProgressTextBox.text = "$CurrentH is now Authenticating against AD Domain $CurrentDomain"
}
else
{
        $ProgressTextBox.text = ""
        $ProgressTextBox.text = "$CurrentH is already Authenticating against AD Domain $CurrentDomain"
}
# let things settle 
Start-Sleep 1
...
$ProgressTextBox.text= "Ready For Lab 2 Task 3"
# End of Module